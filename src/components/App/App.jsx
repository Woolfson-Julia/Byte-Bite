    ...
    <Suspense fallback={<Loader />}>
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route path="profile/:recipeType" element={<PrivateRoute component={<ProfilePage />} redirectTo="/auth/login" />} />

          {/* Обмежені роути - тільки для незалогінених */}
          <Route path="auth/:authType" element={<RestrictedRoute component={<AuthPage />} redirectTo="/" />} />
